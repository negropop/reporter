...
Title</label>
 ...
 <input class="form-input rounded-md shadow-sm mt-1 block w-full" name="title" id="name" value="{{$setting->title}}" type="text" wire:model.defer="state.name" autocomplete="name">
...
Email
 ...
 <input class="form-input rounded-md shadow-sm mt-1 block w-full" name="email" id="email" value="{{$setting->email}}" type="email" wire:model.defer="state.email">
...
<div class="col-span-6 sm:col-span-4">
   ...
   Contact Phone
    ...
    <input class="form-input rounded-md shadow-sm mt-1 block w-full" name="phone" value="{{$setting->phone}}" id="email" type="text" wire:model.defer="state.password">
...
<textarea style="width: -webkit-fill-available;"  name="banner300x600" id="" cols="30" rows="10" placeholder="Enter banner300x600 Code">{{$setting->banner300x600}}</textarea>     
   </div>
...
<textarea style="width: -webkit-fill-available;" name="banner728x90" id="" cols="30" rows="10" placeholder="Enter banner728x90 Code">{{$setting->banner728x90}}</textarea>     
   </div>
    ...
    <textarea style="width: -webkit-fill-available;" name="banner970x90" id="" cols="30" rows="10" placeholder="Enter banner970x90 Code">{{$setting->banner970x90}}</textarea>     
       </div>
...
<div class="md:col-span-1">
<div class="px-4 sm:px-0">
<h3 class="text-lg font-medium text-gray-900">Fut</h3>
